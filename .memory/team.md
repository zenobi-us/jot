...
1. Memory cleanup — archived 10 completed tasks/phases
2. Phase 1 Discovery — full inventory of all rename locations
...
2. **[NEEDS-HUMAN]** GitHub repo rename: `zenobi-us/opennotes` → `zenobi-us/jot`
3. Write migration guide for existing users
4. Regenerate notebook-discovery.svg diagram
