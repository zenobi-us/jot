...
## Acceptance Criteria
- [x] A flag (e.g., --explain) shows a short snippet from the best-matching part of the note.
- [x] Keyword hits highlight matched terms in the snippet.
- [x] Semantic hits show a best-effort closest sentence or summary snippet.
