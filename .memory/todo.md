...
## Phase 2 Progress — In-Repo Changes
...
### Remaining:
- [ ] **Step 9**: Pi extension package (pkgs/pi-opennotes/ → pkgs/pi-jot/) — DEFERRED
- [ ] **Phase 3**: GitHub repo rename (manual, needs human)
- [ ] **Phase 4**: External updates, migration guide
